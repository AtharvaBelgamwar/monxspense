...
export function ExpenseTrackerMainPage() {
    ...
    const [recentTransactions, setRecentTransactions] = useState<Transaction[]>([]); // Array of transactions
            ...
            <div className="max-w-4xl mx-auto space-y-6">
                ...
                {needsBalance ? (
                    <div className="bg-white p-4 rounded-lg shadow-lg text-center">
                        <h2 className="text-xl font-bold text-gray-800 mb-4">Set Your Total Balance</h2>
                        <input
                            type="number"
                            value={newBalance}
                        ...
                        />
                        <Button className="bg-purple-600 hover:bg-purple-700 text-white w-full" onClick={handleSetBalance}>
                            Set Balance
                        </Button>
                    </div>
                ) : (
                        ...
                        <div className="max-w-6xl mx-auto space-y-6">
                            <div className="grid md:grid-cols-3 gap-8">
                                ...
                                <Card className="bg-white/90 backdrop-blur-sm shadow-xl transition-all duration-300 ease-in-out hover:shadow-2xl">
                                    ...
                                    <CardContent>
                                        <p className="text-3xl font-bold text-center text-gray-900">${balance.toFixed(2)}</p>
                                        <div className="mt-4">
                                            <input
                                                type="number"
                                                value={addBalance}
                                ...
                                <Card className="bg-white/90 backdrop-blur-sm shadow-xl flex flex-col items-center justify-center transition-all duration-300 ease-in-out hover:shadow-2xl">
                                    <CardHeader className="text-center">
                                        ...
                                        <h2 className="text-xl font-semibold text-gray-800">Last Transaction</h2>
                                    </CardHeader>
                                    <CardContent>
                                        <p className="text-xl font-semibold text-center text-gray-900">
                                            ${recentTransactions[recentTransactions.length - 1]?.amount.toFixed(2) || 0}
                                        </p>
                                        <p className="text-sm text-center text-gray-600">
                                            {recentTransactions[recentTransactions.length - 1]?.description || 'No Transactions'}
                                        </p>
                                    </CardContent>
                                </Card>
                            ...
                            <Card className="bg-white/90 backdrop-blur-sm shadow-xl transition-all duration-300 ease-in-out hover:shadow-2xl">
                                ...
                                <CardContent>
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex flex-col">
                                            <label htmlFor="amount" className="text-sm font-semibold text-gray-800">Amount</label>
                                            <input
                                                id="amount"
                                                type="number"
                                                className="p-2 border rounded"
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <div className="relative inline-block w-12 h-6 cursor-pointer" onClick={handleToggle}>
                                                <input
                                                    type="checkbox"
                                                    id="recurring"
                                ...
                                <CardFooter>
                                    <Button className="w-full bg-purple-600 hover:bg-purple-700 text-white" onClick={handleAddTransaction}>Add Transaction</Button>
                                </CardFooter>
                            </Card>
                            ...
                            <Card className="bg-white/90 backdrop-blur-sm shadow-xl transition-all duration-300 ease-in-out hover:shadow-2xl">
                                ...
                                <CardFooter>
                                    <Button className="w-full bg-purple-600 hover:bg-purple-700 text-white">View All Transactions</Button>
                                </CardFooter>
                            </Card>

                            <div className="fixed bottom-6 right-6 flex space-x-4">
                                <div className="relative group">
                                    <Button className="rounded-full w-16 h-16 bg-gradient-to-r from-blue-500 to-purple-600 text-white shadow-lg transition-all duration-300 ease-in-out group-hover:w-48 flex items-center justify-center overflow-hidden"
                                        onClick={() => window.location.href = 'http://localhost:3000/ai_chat'}
                                    >
                                        {/* Initially shown small "AI" */}
                                        <span className="absolute text-lg group-hover:hidden">AI</span>
                            ...
                            <div className="fixed bottom-6 left-6">
                                ...
                                <div className="relative group">
                                    <Button className="rounded-full w-16 h-16 bg-gradient-to-r from-green-500 to-yellow-500 text-white shadow-lg transition-all duration-300 ease-in-out group-hover:w-48 flex items-center justify-center overflow-hidden"
                                        onClick={() => window.location.href = 'http://localhost:3000/visualisations'}
                                    >
                                        {/* Initially shown small "Pie" */}
                                        <span className="absolute text-lg group-hover:hidden">Pie</span>
