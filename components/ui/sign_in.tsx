...
export function SignInComponent() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-400 via-pink-500 to-red-500">
      <Card className="w-full max-w-md mx-4 bg-white/90 backdrop-blur-sm shadow-xl transition-all duration-300 ease-in-out hover:shadow-2xl">
        <CardHeader className="text-center">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-2">MonXpense</h1>
          <p className="text-gray-600">Sign in to manage your expenses with ease</p>
        </CardHeader>
